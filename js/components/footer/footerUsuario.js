export function crearFootterUsuario() {
  var respuestaHTML = "";
  respuestaHTML += `
  <footer class="footer row row-cols-1 row-cols-sm-2 row-cols-md-5 py-3 mt-2 border-top text-light">
    ...
    <div class="col text-center">
        ...
        <ul class="nav flex-column ">
            ...
            <p class="mb-0">+593 000 000 000</p>
            <p class="mb-0">Email:</p>
            <p class="mb-0">ejempo@gmail.com</p>
            <p class="mb-0">Dirección:</p>
            <p class="mb-0">Calle 1 y Calle 2</p>
            <p class="mb-0">Cuenca - Ecuador</p>
    ...
    <div class="col mb-3">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.7297960760498!2d-79.02338412553983!3d-2.8940308970824424!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91cd22a7ddde6ff3%3A0xc8680dd1b8adccd7!2sFederaci%C3%B3n%20Deportiva%20del%20Azuay!5e0!3m2!1ses-419!2sec!4v1715555650131!5m2!1ses-419!2sec" width="200" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</footer>`
